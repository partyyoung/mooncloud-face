...
public class ImageLoader {
	...
	public static BufferInfo getI420FromInputStream(InputStream inputStream) {
		byte[] yuv = null;
		int w = 0;
		int h = 0;
		try {
	...
	public static BufferInfo getBGRFromInputStream(InputStream inputStream) {
		byte[] bgr = null;
		int width = 0;
		int height = 0;
		try {
